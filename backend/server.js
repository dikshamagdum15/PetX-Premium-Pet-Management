...
// If your middleware file uses "exports.errorHandler", use destructuring: { errorHandler }
// If it uses "module.exports = errorHandler", the current line is fine.
...
} else if (errorHandler && typeof errorHandler.errorHandler === 'function') {
